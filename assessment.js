...
// #2 Add a nw key/value pair to the me object using dot notation. The new key should be 'faveColor' and set it to your favorite color as a string

me.faveColor = "green";

// #3 Below is an object, 'messag'. Below it, add a 'text' key using bracket notation and assign it a string of whatever you would like.
...
// #5 Create an arra called 'myFriends' with four of your friends names

var myFriends = ["Frank", "Lynn", "Joscif", "Omar"];
